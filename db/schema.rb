...
ActiveRecord::Schema.define(:version => 20130819233854) do
  ...
  add_index "direcciones", ["descripcion", "usuario_id"], :name => "index_direcciones_on_descripcion_and_usuario_id", :unique => true
