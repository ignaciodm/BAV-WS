class MoveAdminNotesToComments < ActiveRecord::Migration
  def self.up
    remove_index  :admin_notes, [:usuario_type, :usuario_id]
    rename_table  :admin_notes, :active_admin_comments
    rename_column :active_admin_comments, :usuario_type, :author_type
    rename_column :active_admin_comments, :usuario_id, :author_id
  ...
  def self.down
    ...
    rename_column :active_admin_comments, :author_id, :usuario_id
    rename_column :active_admin_comments, :author_type, :usuario_type
